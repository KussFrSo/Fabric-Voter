...
public class RegistrarVotacionDTO {
    ...
    @ApiModelProperty(value = "Nombre votacion", example = "¿Debe donarse a Caritas el dinero?")
    String nombre;
    ...
    @ApiModelProperty(value = "Lista de propuestas",
            example = "[{'nombre': 'Propuesta1', 'detallePropuesta': 'Si', 'idPropuesta': 1, 'votos': 10}, {'nombre': 'Propuesta2', 'detallePropuesta': 'No', 'idPropuesta': 2, 'votos': 5}]")
